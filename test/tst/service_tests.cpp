...
//        m_test_queue.reset((queue_adapter<task>*) new stl_queue_adapter<task>());
//        m_result_queue.reset((queue_adapter<task>*) new stl_queue_adapter<task>());
//    }
//
...
//    std::shared_ptr<queue_adapter<task>> m_test_queue;
//    std::shared_ptr<queue_adapter<task>> m_result_queue;
//};
//
