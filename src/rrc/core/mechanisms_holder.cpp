...
rrc::mechanisms_holder::mechanisms_holder(int argc, char** argv, abstract_launcher& launcher,
        ...
        : m_launcher(launcher),
          m_system_mechanism_queue(queue_adapter_factory.create()),
          m_advertising_mechanism_queue(queue_adapter_factory.create()),
          m_service_mechanism_queue(queue_adapter_factory.create()),
          m_settings_mechanism_queue(queue_adapter_factory.create()),
