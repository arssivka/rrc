...
namespace rrc {
    ...
    public:
        ...
        ServiceMechanism(std::shared_ptr<AbstracrTaskQueueAdapter> syncQueue);
        ...
        void call(const Name& name, std::shared_ptr<TaskHub> resultHub, std::shared_ptr<Buffer> input);
